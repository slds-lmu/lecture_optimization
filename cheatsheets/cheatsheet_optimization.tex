...
\title{Optimization :\,: CHEAT SHEET} % Preserve original header styling
...
\begin{columns}
				...
				\parbox[t][\columnheight]{\textwidth}{
					...
					\end{myblock}
						...
						\end{codebox}
 						...
 						\hspace*{1ex}
						\begin{codebox}
							 $\thetav, \thetavh \in \Theta$ : parameter $\thetav$ of a distribution and its estimate $\thetavh$
						\end{codebox}
 						\hspace*{1ex}
						\begin{codebox}
	...
	\begin{column}{.31\textwidth}
		\begin{beamercolorbox}[center]{postercolumn}
				\begin{minipage}{.98\textwidth}
					\parbox[t][\columnheight]{\textwidth}{
						\begin{myblock}{Probability Theory and Statistics (cont.)}
							\begin{codebox}
							...
							\begin{codebox}
								 $\mathcal{L}(\thetav), \ell(\thetav): \Theta \to \R$ : likelihood function / log-likelihood function
							\end{codebox}
							\hspace*{1ex} the log likelihood is defined as $\ell(\thetav) := \log \mathcal{L}(\thetav)$
						\end{myblock}
						...
						\end{codebox}
						\hspace*{1ex} usually, $f$ is parameterized by a parameter $\thetav \in \Theta$; we write $f = f(\cdot ~|~ \thetav)$ (e.g. $\fxt = \thetav^\top \xv$)\\
						\begin{codebox}
							 $\thetav, \thetavh \in \Theta$ : model parameter and its estimate
						\end{codebox}
						\hspace*{1ex}
						\begin{codebox}
						...
						\end{codebox}
						\hspace*{1ex} the (empirical) risk maps a parameter $\thetav$, which parameterizes the model $f(\cdot ~|~ \thetav)$, to the sum of losses
