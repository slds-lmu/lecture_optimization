...
\comment{BB}{ist es garantiwert das QI punkt, wenn sie denn valide sind, immer BESSER als x_best sind? weil wir swichtzen immer?}
\item Quadratic interpolation \textbf{not robust}. The following may happen:
\comment{BB}{hier wäre es päter mal gut diese fälle einfach mal zu zeigen (interpolation)}
\begin{itemizeL}
...
\comment{BB}{es gab noch andere varianten von brent, nicht unbedingt mit golden section, die könnten wir noch erwähnen}
\begin{itemizeM}
...
\comment{JM}{https://mil.ufl.edu/nechyba/www/__eel6825.f2003/course_materials/t11.neural_networks/papers/nric_ch10.1-2.pdf --> Hier könnten noch Details sein}
...
\comment{BB}{wie schwer ist der beweis? deep dive?}
