...
\newcommand{\fleft}{f_{\text{left}}} % f_left
\newcommand{\fright}{f_{\text{right}}} %f_right
\newcommand{\fnew}{f_{\text{new}}} % f_new
\newcommand{\fbest}{f_{\text{best}}} % f_best
\newcommand{\xii}{x^{(i)}} % x^(i)
