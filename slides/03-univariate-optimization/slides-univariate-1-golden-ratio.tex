...
\comment{BB}{maybe we should at least briefly mentin the term "bracketing" }
\comment{BB}{vielleicht, ich weiß wir haben das rausgemschmissen, aber wenigsten KURZ aufzählen welche andere verfahren es univariate gibt? mindestens KURZ eine slide zu newton und sekantenverhren? oder nur newton? mini diksussion dazu?}
...
\comment{BB}{wir sollten auch sagen, können wir auch am ende, was passiert wenn die fun nicht unimodal ist. buw hier besser WARUM wir das requiren}
\end{framev}
...
\comment{BB}{das kurz nochmal visualisieren mit dem "reingehen?" also wo die punkte gelegt werden}
