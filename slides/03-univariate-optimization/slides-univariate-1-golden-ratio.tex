...
\newcommand{\xleft}{x_{\text{left}}} % x_left
\newcommand{\xright}{x_{\text{right}}} %x_right
\newcommand{\xnew}{x_{\text{new}}} % x_new
\newcommand{\xbest}{x_{\text{best}}} % x_best
...
Let $f: \R \to \R$ (search starts over interval $(\xleft,\xright)$ in practice)\\
\lz 
...
\vspace*{0.2cm} 
\image{figure_man/golden-ratio-1.png}
}
\only<2>{
Propose random point in interval 
\image{figure_man/golden-ratio-2.png}
\begin{scriptsize}
...
\image{figure_man/golden-ratio-3.png}
}
\only<4>{
If it is better: proposal becomes current best
\image{figure_man/golden-ratio-4.png}
}
\only<5>{
New search interval: around current best 
\image{figure_man/golden-ratio-5.png}
}
\only<6>{
Propose a random point  
\image{figure_man/golden-ratio-6.png}
}
\only<7>{
Compare proposal against current best
\image{figure_man/golden-ratio-7.png}
}
\only<8>{
If it is better: proposal becomes current best
\image{figure_man/golden-ratio-8.png}
}
\only<9>{
New search interval: around current best
\image{figure_man/golden-ratio-9.png}
}
\only<10>{
Propose a random point
\image{figure_man/golden-ratio-10.png}
}
\only<11>{
Compare proposal against current best 
\image{figure_man/golden-ratio-11.png}
}
\only<12>{
If it is better: proposal becomes current best
\image{figure_man/golden-ratio-12.png}
}
\only<13>{
New search interval: around current best
\image{figure_man/golden-ratio-13.png}
}
\end{frame}
