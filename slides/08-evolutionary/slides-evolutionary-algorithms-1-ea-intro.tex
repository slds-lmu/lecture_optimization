...
\comment[NOTE]{BB}{die notation ist hier leider falscjh auf der folie weil aus dem HPO paper, wir müssen x statt lambda benutzen}
\end{framev}
...
\comment[NOTE]{BB}{bei dem encoding bei real values muss doch ein vector stehen. klarer gene zeigen}
\end{framev}
...
\comment[NOTE]{BB}{immer noch recht unklar wie das hier geht}
\end{small}
\end{framev}
...
\vfill
\splitVCC[0.35]{
\imageC[1]{figure/ea_parent_selection.pdf}
}{
