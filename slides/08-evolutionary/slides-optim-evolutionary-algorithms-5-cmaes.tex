...
\begin{framev}[fs=small]{Covariance Matrix Adaptation}
...
\end{itemize}
\vfill
\imageC[0.5]{figure_man/cmaes/cmaes_generations.png}
...
\imageC[0.95]{figure_man/cmaes/cmaes_update_1.png}
\end{enumerate}
\end{framev}
...
$$
\imageC[0.95]{figure_man/cmaes/cmaes_update_2.png}
...
\imageC[0.95]{figure_man/cmaes/cmaes_update_21.png}
\spacer
...
\imageC[0.95]{figure_man/cmaes/cmaes_update_3.png}
...
\imageC[0.95]{figure_man/cmaes/cmaes_update_4.png}
\spacer
{\small
...
\imageC[0.95]{figure_man/cmaes/cmaes_update_5.png}
\end{enumerate}
\end{framev}
...
\item \textbf{Update mean}
\imageC[0.95]{figure_man/cmaes/cmaes_update_6.png}
\item \textbf{Update covariance matrix}
\imageC[0.95]{figure_man/cmaes/cmaes_update_7.png}
...
\imageC[0.95]{figure_man/cmaes/cmaes_update_8.png}
\end{enumerate}
\end{framev}
...
\begin{framev}[fs=small]{Updating $\sigma$: Methods Step-Size Control}
\begin{itemizeL}
...
\end{itemizeL}
\vfill
\imageC[0.7]{figure_man/cmaes/cumulative-step-size.png}
\end{framev}
