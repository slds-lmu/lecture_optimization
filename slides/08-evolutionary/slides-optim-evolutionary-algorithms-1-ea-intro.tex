...
\begin{framev}[fs=footnotesize]{Encoding}
...
\end{itemize}
\splitVCC[0.5]{
\imageC[0.7]{figure_man/encoding_tree_1.png}
}{
\imageC[0.7]{figure_man/encoding_tree_2.png}
}
...
\sourceref{https://www.scribd.com/document/430241958/genetic-algorithm}
\end{framev}
