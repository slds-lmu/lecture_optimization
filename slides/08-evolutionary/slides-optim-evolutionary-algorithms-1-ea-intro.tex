...
\begin{framev}[fs=footnotesize]{Notation and Terminology}
\begin{itemize}
...
\begin{framev}[fs=small]{Encoding}
...
\end{itemize}
\imageC[0.7]{figure_man/encoding_binary_numeric.png}% https://docs.google.com/presentation/d/12v81ZaLxJUgXVUBy3VdW0y6q7OKHS_6lFcQym3yeYsg/edit#slide=id.p
\spacer
\begin{itemize}
\item Tree encoding: Tree objects
\end{itemize}
\splitVCC[0.5]{
\imageC[0.95]{figure_man/encoding_tree_1.png}
}{
\imageC[0.95]{figure_man/encoding_tree_2.png}
}
{\footnotesize
