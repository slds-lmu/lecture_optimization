...
figure/himmelblau-iter3_probabilities
}{
\item Motivation
...
\comment[NOTE]{BB}{besser über verteilung definieren, nicht über neighbaorhood}
...
\begin{figure}
\imageC[0.68]{figure/metropolis-local-search.png}
...
\begin{figure}
\imageC[0.6]{figure/metropolis-algorithm.png}
\caption*{
\footnotesize
...
\spacer
\imageC[0.6]{figure/metropolis-algorithm2.png}
\end{framei}
...
\comment[NOTE]{BB}{das hier ist etwas komisch so. was wenn die funktion neg ist? wo kommt das eigentlich her?}
\end{framei}

\comment[NOTE]{BB}{8 damen problem zeigen}
...
\comment[NOTE]{BB}{pro und cons fehlen hier komplett:
ist sehr billig in bezig auf die operationen.
kann man super auf unerschiedliche auch kompliziertere problem anweden, ist sowas wie eine "meta" heuristik.
andersherum hat es viele control param, wie man genau cool down und sampling macht ist unklar, gibt 1000 varianten.
kann man auch auf diskrete probleme anwenden}
