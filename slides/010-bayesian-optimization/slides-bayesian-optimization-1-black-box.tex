...
\end{center}
\begin{footnotesize}
Left: Simplices of the Nelder-Mead algorithm. Middle: Components of an evolutionary algorithm. Right: BO vs. CMAES vs. Random on 2D Ackley.\\
CMAES initially performs poorly as it needs some iterations to initialize and is not made for expensive black-box problems.
\end{footnotesize}
\end{figure}
