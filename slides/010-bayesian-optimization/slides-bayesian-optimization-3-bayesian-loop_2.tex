...
\only<1>{
\begin{itemize}
\item NB1: We now take the expectation in the tail, 
instead of the prob as in PI.

\item NB2: Improvement is always assumed $\geq 0$. So in a certain sense, we only use uncertainty optimistically. This enforces exploration.
\end{itemize}
}
