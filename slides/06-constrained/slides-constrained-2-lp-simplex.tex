...
$$L(\xv, \bm{\mu}, \bm{\lambda}) = \mathbf{c}^T\xv - \bm{\mu}^T\xv - \bm{\lambda}^T(\Amat\xv - \mathbf{b})$$
with $\bm{\mu} \ge \zero$
\item Optimal solution satisfies $\frac{\partial L}{\partial \xv}=0$, i.e., $\Amat^T \bm{\lambda} + \bm{\mu} = \mathbf{c}$
\item Decompose stationarity condition into $\mathcal{B}$ and $\mathcal{V}$ components:
$$
\Amat^T \bm{\lambda} + \bm{\mu} = \mathbf{c} 
\quad \implies \quad
\begin{cases}
\Amat_{\mathcal{B}}^T \bm{\lambda} + \bm{\mu}_{\mathcal{B}} = \mathbf{c}_{\mathcal{B}} \\
\Amat_{\mathcal{V}}^T \bm{\lambda} + \bm{\mu}_{\mathcal{V}} = \mathbf{c}_{\mathcal{V}}
\end{cases}
$$
\end{framei}
...
$$
\Amat_{\mathcal{B}}^T \bm{\lambda} + \underbrace{\bm{\mu}_{\mathcal{B}}}_{= 0} = \mathbf{c}_{\mathcal{B}} \quad \implies \quad \bm{\lambda} = \Amat_{\mathcal{B}}^{-T} \mathbf{c}_{\mathcal{B}}
$$
\item Use this to obtain:
\begin{align*}
\Amat_{\mathcal{V}}^T \bm{\lambda} + \bm{\mu}_{\mathcal{V}} &= \mathbf{c}_{\mathcal{V}}\\
\bm{\mu}_{\mathcal{V}} &= \mathbf{c}_{\mathcal{V}} - \Amat_{\mathcal{V}}^T \bm{\lambda}\\
\bm{\mu}_{\mathcal{V}} &= \mathbf{c}_{\mathcal{V}} - \left( \Amat_{\mathcal{B}}^{-1} \Amat_{\mathcal{V}} \right)^T \mathbf{c}_{\mathcal{B}}
\end{align*}
...
$\bm{\mu}_{\mathcal{V}} = \mathbf{c}_{\mathcal{V}} - \left( \Amat_{\mathcal{B}}^{-1} \Amat_{\mathcal{V}} \right)^T \mathbf{c}_{\mathcal{B}} = (3, -1)^T$\\
\spacer
...
In the second iteration, we find $\xv_{\mathcal{B}}=(1,8)^T, \bm{\lambda} = (0, -\frac{1}{2})^T, \bm{\mu}_{\mathcal{V}} = (1, \frac{1}{2})^T$.\\
\spacer
