...
\begin{itemize}
    ...
    % \begin{center}
    %     \includegraphics[height=0.4\textheight,keepaspectratio]{figure_man/cons-geo-interpretation.png}
    % \end{center}
...
\begin{itemize}
    ...
    % \vspace{\baselineskip}
    % \begin{center}
    %     \includegraphics[width=0.45\textwidth]{figure_man/cons-negative-gradient.png}
    % \end{center}
