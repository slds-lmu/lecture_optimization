...
$$
\imageC[0.60]{figure/cons-linear-pro-example.png}
\end{framei}
...
\imageC[0.5]{figure/cons-linear-pro-example.png}
\end{framei}
...
\imageC[0.65]{figure/cons-opposite-direction.png}
\end{framei}
...
\end{enumerate}
\imageC[1]{figure/cons-solutions-lp.png}
\end{framev}
