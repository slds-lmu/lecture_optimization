...
\comment{UU}{It would be nice to have an overview of necessary and sufficient conditions for optimality in constrained problems, see, e.g., https://www.math.ucla.edu/~lvese/273.1.06f/Summary.pdf.}
