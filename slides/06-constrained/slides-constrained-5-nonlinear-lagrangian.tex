...
% \begin{equation*}
% 	\min_{\thetab} \max_{\alpha \ge 0} \mathcal{L}(\xv, \bm{\alpha}) = \min_{\thetab} \max_{\alpha \ge 0} \left\{\|\yv - \Xmat \thetab\|_2^2 + \alpha \left(\|\thetab\|_1 - t\right)\right\}.
% \end{equation*}
