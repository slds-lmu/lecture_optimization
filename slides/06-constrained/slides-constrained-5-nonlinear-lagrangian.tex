...
\comment[NOTE]{UU}{It would be nice to have an overview of necessary and sufficient conditions for optimality in constrained problems, see, e.g., https://www.math.ucla.edu/~lvese/273.1.06f/Summary.pdf.}
...
\vfill
\imageC[0.7]{figure_man/milkmaid1.png}
\end{framei}
...
\vfill
\imageC[0.5]{figure_man/milkmaid2.png}
\end{framei}
...
\vfill
\imageC[0.5]{figure_man/milkmaid3.png}
...
$$
\imageC[0.6]{figure_man/ellipse.png}
\end{framei}
...
\imageC[0.55]{figure_man/milkmaid4.png}
...
\imageC[0.55]{figure_man/milkmaid5.png}
\end{framei}
...
\end{itemize}
\imageC[0.65]{figure_man/constraint_lagrange.png}
\end{framei}
