# Used in: ../04-multivariate-first-order/01-gd.tex,
#   01-momentum.tex,
#   04-sgd.tex (snippet currently not used)
#
...
# ../04-multivariate-first-order/01-gd.tex
run_gd = TRUE
# 01-momentum.tex
run_momentum = TRUE
# 04-sgd.tex
...
# --- SGD batch fraction comparison (04-sgd.tex) --
if (run_sgd) {
  set_nn_seed(1111L)
  epochs = 100L
  learning_rate = 0.001
