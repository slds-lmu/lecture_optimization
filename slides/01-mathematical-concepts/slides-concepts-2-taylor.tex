...
\begin{columns}
    \begin{column}{0.4\textwidth}
        %   \animategraphics[loop,controls,width=\linewidth]{7}{figure_man/Taylor2D_1st}{0}{359}
...
\begin{columns}
    \begin{column}{0.4\textwidth}
        %   \animategraphics[loop,controls,width=\linewidth]{7}{figure_man/Taylor2D_2nd-}{0}{359}
