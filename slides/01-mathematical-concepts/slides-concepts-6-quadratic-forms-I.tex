...
\lecturechapter{6}{Quadratic Forms I}
...
\begin{vbframe}{Univariate Quadratic Functions}
  ...
  with $\bm{A} \in \R^{d \times d}$ being a full-rank matrix, $\bm{b} \in \R^d$, and $c \in \R$. % To also keep things simple here, we will set $\bm{b}$ and $c$ to zero. 
