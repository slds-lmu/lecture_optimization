...
\begin{vbframe}{Taylor series (univariate)}
    ...
    \textcolor{red}{Add 1D visualization for Taylor series (m=1, 2, 3) for logarithm function. }
...
\end{pmatrix}
$$
The Eigenvalues at $a=(\frac{-\pi}{2},0)$, $b=(0,\frac{-\pi}{2})$ and $c=(\frac{-\pi}{2},0)$ are $[-1, -1], [1, -1]$ and $[1, 1]$, respectively. The signs of the Eigenvalues can each be retraced in the following plot:
\end{footnotesize}
