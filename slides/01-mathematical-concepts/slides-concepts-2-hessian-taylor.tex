...
\item Taylor Polynomials (Univariate)
\item Taylor Series
\item Hessian Matrix
\item Taylor Polynomials (Multivariate)}
...
\lecturechapter{Hessian Matrix \& Taylor Approximations}
...
\begin{vbframe}{Remainder estimation}
