...
Let $f: \R^n \to \R$, $f \in \mathcal{C}^k$ at $\bm{a} \in \R^n$. Then 
...
with $\bm{\alpha} \in \N^n$ and the multi-index notation
\begin{itemize}
  \item $|\bm{\alpha}| = \alpha_1 + \cdots + \alpha_n$
  \item $\bm{\alpha}! = \alpha_1! \cdots \alpha_n!$
  \item $\xv^{\bm{\alpha}} = x_1^{\alpha_1} \cdots x_n^{\alpha_n}$
  \item $D^{\bm{\alpha}} f = \frac{\partial^{|\bm{\alpha}|} f}{\partial x_1^{\alpha_1} \cdots \partial x_n^{\alpha_n}}$ 
\end{itemize}
