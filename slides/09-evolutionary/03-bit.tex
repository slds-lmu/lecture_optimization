...
\vfill
\imageC[0.65]{figure/one_max_example.pdf}
...
\item \textbf{Mutation:} Bit flip with $p = 0.02$
...
\imageC[1]{figure/var-selection1.png}
\end{framev}


\begin{framev}{Example 2: Feature selection}
\imageC[1]{figure/var-selection2.png}
\end{framev}
