...
\item If the norm is the $L_1$ norm, this is the famous basis pursuit problem \sourceref{https://en.wikipedia.org/wiki/Basis_pursuit}
\vfill
...
\item[] \textbf{Definition} Let $\| \xv \|$ be the norm of $\xv$. The dual norm $\| \xv \|_*$ is defined as
$$
\| \xv \|_* = \max_{\|\zv\| \le 1} \zv^T \xv
$$
...
$$
\vfill
\item[] \textbf{Example} The dual norm of the $L_p$ norm $\| \cdot \|_p$ is the $L_q$ norm $\| \cdot \|_q$ where $1/p + 1/q = 1$
\end{framei}
