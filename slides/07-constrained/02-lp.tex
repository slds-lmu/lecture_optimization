...
$$
\imageC[0.50]{figure/cons-linear-pro-example.png}
\end{framei}
...
\imageC[0.37]{figure/cons-linear-pro-example.png}
\end{framei}
...
\imageC[0.55]{figure/cons-opposite-direction.png}
\end{framei}
...
\end{enumerate}
\imageC[0.80]{figure/cons-solutions-lp.png}
\end{framev}
