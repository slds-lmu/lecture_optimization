...
f: \; \S \to \R,
$$
where $\S$ is usually box constrained.
\vfill
\splitVCC[0.4]
...
If we are lucky ...
\begin{itemize}
\item ... we have an analytic description of $f: \; \S \to \R$
...
\begin{itemize}
\item ... there is no analytic description of $f: \; \S \to \R$ (\textbf{black box})
...
\begin{enumerate}
\item Robot Gait Optimization: The robot's gait is controlled by a \textbf{parameterized controller} \furtherreading{CALANDRA2014BOBIPED}
\spacer
...
\begin{enumerate}
\setcounter{enumi}{1}
\item Optimization of a cookie recipe \furtherreading{KOCHANSKI2017DESSERT}
\spacer
\imageC[0.5][https://www.bettycrocker.com]{figure_man/cookie.jpg}
...
\vfill
\splitV[0.5]
{\imageC[0.9]{figure/black_box_0.png}}
{\imageC[0.9]{figure/black_box_1.png}}
...
\end{itemize}
\vfill
\imageC[0.55]{figure/black_box_2.png}
\begin{footnotesize}\begin{center}
