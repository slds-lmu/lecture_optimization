...
\begin{framei}[fs=small]{Random Forest - Mean and Variance}
...
\item Mean prediction of forest: $\fh: \mathcal{S} \to \R, \xv \mapsto \frac{1}{B} \sum_{b = 1}^{B} \fh_{b}(\xv) $
...
\imageC[0.95]{figure/surrogate_1.png}
\end{framev}
...
\imageC[0.6]{figure/surrogate_2.png}
\begin{footnotesize}
