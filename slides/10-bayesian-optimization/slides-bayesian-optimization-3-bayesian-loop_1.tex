...
\end{itemize}
\vfill
\imageC[0.5]{figure/bayesian_loop_sm_normal.png}
\begin{footnotesize}
...
\imageC[0.5]{figure/bayesian_loop_sm_fmin.png}
...
$\tau = 1$
\vfill
\imageC[0.7]{figure/bayesian_loop_lcb_0.png}
\vfill
...
$\tau = 5$
\vfill
\imageC[0.7]{figure/bayesian_loop_lcb_1.png}
\end{framev}
...
$\tau = 10$
\vfill
\imageC[0.7]{figure/bayesian_loop_lcb_2.png}
\end{framev}
