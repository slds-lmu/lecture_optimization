...
\vfill
\imageC[0.5]{figure_man/bayesian_loop_ee.png}
\vfill
\end{framev}
...
$\tau = 1$
\vfill
\imageC[0.6]{figure_man/bayesian_loop_lcb_0.png}
\vfill
...
$\tau = 5$
\vfill
\imageC[0.6]{figure_man/bayesian_loop_lcb_1.png}
\end{framev}
...
$\tau = 10$
\vfill
\imageC[0.6]{figure_man/bayesian_loop_lcb_2.png}
\end{framev}
