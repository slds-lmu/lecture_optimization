...
\comment[NOTE]{LS}{das geht halt eigentlich nicht durch. also man muesste vermutlich den grenzwert betrachtne aber das problem ist dass wir eigentlich keinen limes der varianz gegen 0 betrachten sondern die varianz ist 0. dann muesste man phi(fmin - f(x)/s(x)) explizit als phi(-inf) definieren.... was irgendwie schwierig ist. die musterloesung der klausur ws24/25 ist hier besser
also die musterloesung ist fuer ei. fuers pi muss man hier anders argumentieren}
\begin{itemize}
\item $\sh(\xv) = 0$,
