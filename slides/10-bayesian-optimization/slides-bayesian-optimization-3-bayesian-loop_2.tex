...
\vfill
\imageC[0.6]{figure_man/bayesian_loop_pi_2.png}
\vfill
...
...
\vfill
\imageC[0.6]{figure_man/bayesian_loop_pi_3.png}
\end{framev}
...
\vfill
\imageC[0.6]{figure_man/bayesian_loop_pi_4.png}
\end{framev}
...
...
\vfill
\imageC[0.6]{figure_man/bayesian_loop_pi_5.png}
\end{framev}
...
...
\vfill
\imageC[0.6]{figure_man/bayesian_loop_pi_6.png}
\end{framev}
...
...
\vfill
\imageC[0.6]{figure_man/bayesian_loop_pi_7.png}
\end{framev}
...
\vfill
\imageC[0.6]{figure_man/bayesian_loop_pi_8.png}
\end{framev}
...
...
\vfill
\imageC[0.6]{figure_man/bayesian_loop_pi_9.png}
\end{framev}
...
\begin{framev}[fs=small]{Expected Improvement}
...
\vfill
\imageC[0.6]{figure_man/bayesian_loop_1.png}
\vfill
...
... evaluate that point, refit the SM and propose the next point
\vfill
\imageC[0.6]{figure_man/bayesian_loop_2.png}
\vfill
(grey point = prev point from last iter)
\end{framev}
...
...
\vfill
\imageC[0.6]{figure_man/bayesian_loop_3.png}
\end{framev}
...
...
\vfill
\imageC[0.6]{figure_man/bayesian_loop_4.png}
\end{framev}
...
...
\vfill
\imageC[0.6]{figure_man/bayesian_loop_5.png}
\end{framev}
...
\vfill
\imageC[0.6]{figure_man/bayesian_loop_6.png}
\vfill
...
\item Under some mild conditions: BO with a GP as SM and EI is a \textbf{global optimizer}, i.e., convergence to the \textbf{global} (!) optimum is guaranteed given unlimited budget (Bull 2011 \sourceref{https://dl.acm.org/doi/pdf/10.5555/1953048.2078198})
\item Cannot be proven for the PI or the vanilla LCB
\item LCB can be proven to converge in a similar manner if the mean-variance trade-off parameter is chosen adaptively and ``correctly'' (Srinivas et al. 2010 \sourceref{https://icml.cc/Conferences/2010/papers/422.pdf})
