...
\begin{framei}{Probability of Improvement}
...
\vfill
\imageC[0.6]{figure/bayesian_loop_pi_1.png}
...
\vfill
\imageC[0.7]{figure/bayesian_loop_pi_2.png}
...
...
\vfill
\imageC[0.7]{figure/bayesian_loop_pi_3.png}
\end{framev}
...
\vfill
\imageC[0.7]{figure/bayesian_loop_pi_4.png}
\end{framev}
...
...
\vfill
\imageC[0.7]{figure/bayesian_loop_pi_5.png}
\end{framev}
...
...
\vfill
\imageC[0.7]{figure/bayesian_loop_pi_6.png}
\end{framev}
...
...
\vfill
\imageC[0.7]{figure/bayesian_loop_pi_7.png}
\end{framev}
...
\vfill
\imageC[0.7]{figure/bayesian_loop_pi_8.png}
\end{framev}
...
...
\vfill
\imageC[0.7]{figure/bayesian_loop_pi_9.png}
\end{framev}
...
\vfill
\imageC[0.7]{figure/bayesian_loop_1.png}
\vfill
...
... evaluate that point, refit the SM and propose the next point
\vfill
\imageC[0.7]{figure/bayesian_loop_2.png}
\vfill
(grey point = prev point from last iter)
\end{framev}
...
...
\vfill
\imageC[0.7]{figure/bayesian_loop_3.png}
\end{framev}
...
...
\vfill
\imageC[0.7]{figure/bayesian_loop_4.png}
\end{framev}
