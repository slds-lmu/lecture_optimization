...
\vfill
\imageC[0.8]{figure/multicrit_0.png}
\end{framev}
...
Hypervolume example:
\vfill
\imageC[0.7]{figure/multicrit_1.png}
...
\vfill
\center \furtherreading{HORN2015MBMO}
\end{framev}
...
\begin{framev}[align=top]{SMS-EGO}
...
\imageFixed{8cm}{3cm}[1]{figure_man/\figbase.pdf}
}
\end{framev}
}
