...
g / cb
ggsave("../figure/bayesian_loop_lcb_0.png", plot = g / cb, width = 5, height = 4)
...
g / cb
ggsave("../figure/bayesian_loop_lcb_1.png", plot = g / cb, width = 5, height = 4)
...
g / cb
ggsave("../figure/bayesian_loop_lcb_2.png", plot = g / cb, width = 5, height = 4)
