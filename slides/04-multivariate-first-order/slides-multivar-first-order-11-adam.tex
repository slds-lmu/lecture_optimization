...
\begin{frame2}{Comparison of optimizers: Animation}
\vfill
\splitV[0.49]{
...
\begin{frame2}{Comparison on quadratic form}
\vfill
\imageC[0.8]{figure_man/momentum/comparison_adam.png}
\vfill
