...
\comment{BB}{polyak noch rein irgendwo}
...
\comment{BB}{nicht so toll weil adam hier gar nicht dabei ist, und andere die wir nicht kennen. außerdem wären mehere screenshorts scvhön damit man die anim direkt auf den folien zeigen kann}
\end{framev}


\begin{framev}{Comparison on quadratic form}
\image{figure_man/momentum/comparison_adam.png}
\comment{UU}{Kann der Plot überhaupt stimmen?  Woher weiß Adam gleich am Startpunkt, dass es in Richtung Minimum marschiert?}
