...
\comment{BB}{wir könnten noch etwas über die verteilung von den grad reden, CLT usw. können wir später}
\comment{BB}{hier könnte man die claims als bsp zeigen
vielleicht kann man mal batchsize und step size variieren auf einem praktiven bsp}
\comment{BB}{wäre schön wenn wir die aussagen hier empirisch besser zeigen würden
Hier könnte man vielleicht fündig werden: https://udlbook.github.io/udlbook/ Kap. 9+20.}
\comment{BB}{was hier auf der folie steht ist nicht so super klar finde ich.... können wir das etwas verbessern}
\comment{UU}{Man könnte noch einen Bezug herstellen zwischen der Größe dieser Varianz und der Größe der "confusion area".}
\end{blocki}
\vfill
...
\comment{BB}{es wäre schön einmal SGD gegen GD auf echten daten zu sehen. zb bei einem NN. man muss gucken wie man die x-achse skaliert. man kann einmal fevals vs y zeigen. aber auch "datenpunkt" gegen y.
