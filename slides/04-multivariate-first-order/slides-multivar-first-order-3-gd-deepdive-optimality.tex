...
\comment{LS}{check the following https://arxiv.org/abs/1405.4980
...
\end{alignat*}
\comment{UU}{Vielleicht bietet sich hier ein Bild an, da die Funktion f "gesandwicht" wird von der Taylor-Entwicklung 1. und 2. Ordnung.}
