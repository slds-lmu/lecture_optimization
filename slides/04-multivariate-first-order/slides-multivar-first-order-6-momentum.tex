...
{
\imageC[0.6]{figure_man/momentum_illustration_medium.png} %SOURCE: Khandewal, GD with Momentum, RMSprop and Adam Optimizer, 2020.
\smallskip
...
\smallskip
\footnotesize Successive gradients pointing in same/different directions increase/decrease velocity.\\
\footnotesize Further geometric intuitions and detailed explanations: \url{https://distill.pub/2017/momentum/}
\end{frame2}
...
\imageC[0.5]{figure_man/momentum/sgd_momentum_saddlepoint.png}
\smallskip
\footnotesize GD was slowing down at the saddle point (vanishing gradient).\\
\footnotesize GD with momentum ``breaks out'' of the saddle point and moves on.
\end{frame2}
...
\begin{frame2}{Nesterov Accelerated Gradient}
\begin{itemize}
...
\smallskip
\footnotesize Nesterov momentum update evaluates gradient at the ``look-ahead'' position.\\
\footnotesize Source: \url{https://cs231n.github.io/neural-networks-3/}
\end{frame2}


\begin{frame2}{Momentum vs. Nesterov}
\imageC[0.8]{figure_man/nesterov_momentum.png}
\smallskip
\footnotesize GD with momentum (\textbf{left}) vs. GD with Nesterov momentum (\textbf{right}).\\
\footnotesize Near minima, momentum makes a large step due to gradient history.\\
\footnotesize Nesterov momentum ``looks ahead'' and reduces effect of gradient history.\\
\footnotesize Source: Chandra, 2015.
\end{frame2}
