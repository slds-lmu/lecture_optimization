...
\comment{BB}{hier hätte ich gerne eine folie: in DL sind sattlepoints das problem nicht lok min. diese folie gibt es schon in DL
ist in DL 4.1, folie 21ff}
\comment{BB}{versuchen "slow crawling" zu zeigen. also vielleicht noch ein bsp wo wir im saddle point nicht steckenbleiben aber an ihm super langsam vorbeilaufen
https://arxiv.org/pdf/1711.05224.pdf}
\comment{BB}{https://bair.berkeley.edu/blog/2017/08/31/saddle-efficiency/ --> ansehen.}
\comment{BB}{benutzen wir hier in den slides manchmal "m" als dim des opt problems? gegen cheat sheet checken}
