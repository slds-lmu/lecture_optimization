...
\item[]
\splitVTT[0.52]
{\imageC[0.85]{figure_man/multimodal.png}\imageC[0.9]{figure_man/difficult_vs_easy.png}}
...
\imageC[0.6]{figure_man/local_hill.png}
\item Source: Goodfellow et al., 2016
...
\imageC[0.6]{figure_man/minima.png}
\item Source: Goodfellow et al., 2016
\end{framei}
...
\vfill
\splitVTT[0.48]{\imageC[0.9]{figure_man/nonconv_ackley_plot.jpg}}{\imageC[0.9]{figure_man/nonconv_ackley_path.jpg}}
\vfill
...
\splitVTT[0.52]
{\textbf{Example:}\\[0.5\baselineskip]
