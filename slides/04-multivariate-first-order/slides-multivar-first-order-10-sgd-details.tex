...
\vfill
\image[]{figure_man/sgd_example_erratic_behavior.png}
\vfill
...
\State \textbf{require} initial parameter $\bm{x}$ and initial velocity $\nuv$ \strut
...
\State Apply update: $\bm{x} \leftarrow \bm{x} + \nuv$
\EndWhile
\end{algorithmic}
\end{algorithm}
\end{framei}
