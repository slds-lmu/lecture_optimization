...
For a more realistic application, we compare optimizers on subset of the MNIST image classification task. 

\begin{itemize}
     \setlength{\itemsep}{1.2em} 
    \item We use a DNN with two hidden layers of sizes $128,64$, ReLu activations, and Kaiming normal init. The loss is cross-entropy
    ...
    \item We set the initial step size to $0.01$ and to $0.1$ for the large step size
\end{itemize}
\end{vbframe}
...
5. Large initial step sizes with decay perform best.}
\end{vbframe}
