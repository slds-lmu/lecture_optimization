...
\begin{vbframe}{Regression (GD + small step size)}
\vspace{-0.4cm}
...
\begin{vbframe}{Regression (GD + med step size)}
\vspace{-0.4cm}
...
\begin{vbframe}{Regression (GD + large step size)}
\vspace{-0.5cm}
...
\begin{vbframe}{Regression (GD + corr. features)}
\vspace{-0.4cm}
...
\begin{vbframe}{Regression (SGD + small step size)}
\vspace{-0.4cm}
...
\begin{vbframe}{Regression (SGD + med step size)}
\vspace{-0.4cm}
...
\begin{vbframe}{Regression (SGD + large step size)}
\vspace{-0.4cm}
...
\begin{vbframe}{Regression (SGD + corr. features)}
\vspace{-0.4cm}
...
\begin{figure}
            ...
            \end{footnotesize}
\end{figure}
No SGD variant converges in $t_{\text{max}}=10000$ iterations. Decay slows down while momentum accelerates optim.
\end{vbframe}
