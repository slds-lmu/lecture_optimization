...
\comment{BB}{Bernd: auch alles tiotal ok so, aber an sich kann man fast überlegen diese beiden beispiele zusammenzulegen.... und dann fände ich eigentlich immer 2d besser als 1d. die zeigen fast das gleiche. passt aber auch so}
...
\comment{BB}{Bernd: Man könnte hier, analog zum Bild darüber, auch rote Striche machen}
\end{framei}
...
\end{itemizeM}
\comment{UU}{Hier könnte noch eine Grafik dazu wie z.B. in Martins and Ning. Engineering Design Optimization, 2021, Fig. 4.25.}
\begin{framed}
