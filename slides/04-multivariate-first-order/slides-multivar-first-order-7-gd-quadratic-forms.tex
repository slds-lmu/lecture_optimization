...
\comment{BB}{es gibt eine analyse von GD auf GF als dyn system. das sagt uns nette stabile lösungen. ich weiß nicht ob das zu schwer ist?
https://ieeexplore.ieee.org/document/8706530}
\comment{BB}{über conjug grad mal reden? mirror GD?}
...
\comment{LS}{we have xTAx -bTx the blogpost has 1/2 and in the next slideset sometimes a 2 s missing;
Visualisierung;
