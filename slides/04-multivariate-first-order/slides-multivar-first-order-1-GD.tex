...
\begin{figure}
	\includegraphics[width=0.7\textwidth]{figure_man/gradient_descent_branin.pdf} \\
	\vspace*{-0.5cm}
	\begin{footnotesize}
		$500$ iterations of GD with constant step size $\alpha = 10^{-4}$ for three different starting poitns.  
	\end{footnotesize}
\end{figure}
