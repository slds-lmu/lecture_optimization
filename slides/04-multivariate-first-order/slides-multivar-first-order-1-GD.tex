...
\comment[NOTE]{BB}{wir können hier vielleicht etwas visueller über den typen im gebirge gehen. es ist neblig, ich kann nur einen metter sehen und will rtunter kommen. also mache ich lokale schritte runter und scanne dann wieder meine 1m umgebung}
\splitVCC[0.6]{
\begin{enumerate}
