...
\comment{BB}{wir sollten dringend das hier mal durchsehen und uns daran orientieren https://ruder.io/optimizing-gradient-descent/}
\comment{BB}{wir sollten generell dieses gesamt subcha machen zu normalied GD --> https://jermwatt.github.io/machine_learning_refined/notes/3_First_order_methods/3_9_Normalized.html}
\comment{BB}{vielleicht sollten wir mal definieren was first order überhaupt heisst. und welche first order verfahren es gibt -- egal ob wir die behandeln}
...
\comment{BB}{wir können hier vielleicht etwas visueller über den typen im gebirge gehen. es ist neblig, ich kann nur einen metter sehen und will rtunter kommen. also mache ich lokale schritte runter und scanne dann wieder meine 1m umgebung}
\splitVCC[0.6]{
\begin{enumerate}
...
\vspace{-0.7cm}
\imageC[0.6]{figure/gradient_descent_NN_0.pdf}
\comment{BB}{hier wäre ein bild vom NN schön gewesen;
kann man doch irgendwie einen 2D schnit der loss ladnscape noch ziegen. und wie GD da durchläuft?}
\end{framei}
...
{\imageFixed{6cm}{2.5cm}[1]{figure_man/gradient_descent_NN_300_history.pdf}}
\comment{BB}{sollte man bei dem beispiel nicht besser sehen dass wir die quadrik erfolgreich approxen können? kommt nicht sooo gut hin?}
\comment{BB}{aich hier sollte eher R_emp auf der achse stehen statt "loss". mehrere bilder mal prüfen}
\end{framev}
