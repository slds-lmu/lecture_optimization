...
\comment[FIX]{TH}{Slide set does not compile!!!}
\comment[NOTE]{BB}{schlechtes start bild}
\comment[NOTE]{BB}{alles bisserl kurz hier. mehr in 2d zeigen. man kann am ende wenisgtesn mehr zu der minimums-statistik sagen, die man von der verteilung der Y zieht}
...
\imageC[1]{figure/metropolis-example-nelder.png}
\comment[NOTE]{BB}{hier haben wir 1d plots dazu, die sind hässlich. 2d wäre schöner}
\end{framev}


\begin{frame}[fragile]{Multi-starts}
Levy function:
...
\end{verbatim}
\comment[NOTE]{BB}{besser hist zeigen... und die ergebnisse der eintelnen runs in 2d. vielleaicht auf anderer funktion wo man auch sieht in wehcle basins man gelaufen ist}
\end{frame}
