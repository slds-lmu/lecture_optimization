...
\titlemeta{% Chunk title (example: CART, Forests, Boosting, ...), can be empty
  ...
  figure_man/himmelblau-iter3_probabilities
  }{
    \item Motivation
...
% \begin{center}
%     \centering
%     \includegraphics[width=0.54\textwidth]{figure_man/himmelblau-Fun3D.png}
%     \includegraphics[width=0.3\textwidth]{figure_man/himmelblau-Fun2D.pdf}
% \end{center}
...
% \begin{figure}
%   \includegraphics<1>[width=0.9\textwidth]{figure_man/himmelblau-iter1.pdf}%
%   \includegraphics<2>[width=0.9\textwidth]{figure_man/himmelblau-iter2.pdf}%
%   \includegraphics<3>[width=0.9\textwidth]{figure_man/himmelblau-iter3.pdf}%
%   \includegraphics<4>[width=0.9\textwidth]{figure_man/himmelblau-iter4.pdf}%
%   \includegraphics<5>[width=0.9\textwidth]{figure_man/himmelblau-iter5.pdf}%
%   \includegraphics<6>[width=0.9\textwidth]{figure_man/himmelblau-iter6.pdf}%
%   \includegraphics<7>[width=0.9\textwidth]{figure_man/himmelblau-iter7.pdf}
%   \caption*{
%     \scriptsize
...
% \only<3>{
%   \includegraphics[width=0.49\textwidth]{figure_man/himmelblau-iter1.png}
...
% %\only<3>{\includegraphics[height = 5cm, width=5.5cm]{figure_man/himmelblau-iter2.png}}%
...
% \only<3>{\includegraphics[width=0.49\textwidth]{figure_man/himmelblau-iter50.png}
...
%           \end{itemize}}%
% \only<4>{\includegraphics[width=0.49\textwidth]{figure_man/himmelblau-iter100.png}
