...
\begin{framei}{Logistic Regression (GD vs. NR)}
\item Let's run GD vs. NR for \textbf{$1000$ steps} (independent features):
\vfill
\imageC[0.8]{figure_man/simu-newton/NR_GD_log_indep_1000iters.pdf}
\imageC[0.8]{figure_man/simu-newton/NR_GD_log_coef_1000indep.pdf}
{\footnotesize Dotted lines indicate global minimizers.}
\vfill
...
\begin{framei}[fs=small]{Runtime comparison (indep.)}
...
\vfill
\imageC[1]{figure_man/simu-newton/NR_GD_runtime_comparison.pdf}
\vfill
...
\vfill
\imageC[1]{figure_man/simu-newton/NR_GD_runtime_comparison_corr.pdf}
\vfill
\item[\textbf{Observations:}]
