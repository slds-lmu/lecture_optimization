...
\imageC[0.8]{../04-multivariate-first-order/figure/simu-linmods/GD_log_med_lr_iters.pdf}
\imageC[0.8]{../04-multivariate-first-order/figure/simu-linmods/GD_log_coef_med.pdf}
...
\imageC[0.7]{figure/simu-newton/NR_GD_log_indep_1000iters.png}
\imageC[0.7]{figure/simu-newton/NR_GD_log_coef_1000indep.png}
...
\imageC[0.8]{figure/simu-newton/NR_GD_log_indep_50iters.png}
\imageC[0.8]{figure/simu-newton/NR_GD_log_coef_50indep.png}
Dotted lines indicate global minimizers.
...
\imageC[0.9]{figure/simu-newton/NR_GD_runtime_comparison.png}
...
\imageC[0.8]{figure/simu-newton/NR_GD_log_indep_50iters_corr.png}
\imageC[0.8]{figure/simu-newton/NR_GD_log_coef_50indep_corr.png}
{\footnotesize Dotted lines indicate global minimizers.}
...
\imageC[0.95]{figure/simu-newton/NR_GD_runtime_comparison_corr.png}
\item[] \textbf{Observations:}
...
\comment[NOTE]{CK}{maybe relevant to mention that second-order optim is debated to actually harm generalization despite solving ERM better if tractable
but this should probably not be done in the simulation comparison chunk but before
https://arxiv.org/pdf/2008.07545}
