...
\comment[NOTE]{BB}{den schritt auf der quadrik visuasilieren?}
...
\comment[NOTE]{BB}{ich glaube hier ist gar nicht GD laufen gelassen  worden sondern normalized GD. außerdem: warum sind die algos nicht in einer legende sichtbar}
