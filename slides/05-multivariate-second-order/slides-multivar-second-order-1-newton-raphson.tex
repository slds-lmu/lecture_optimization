...
\begin{framei}[fs=small]{Limitations: Non-descent directions}
\item \textbf{Problem 1:} In general, $\mathbf{d}^{[t]}$ is not a descent direction (e.g., second step in the previous example):
...
\begin{framei}{Limitations: Computational Cost}
