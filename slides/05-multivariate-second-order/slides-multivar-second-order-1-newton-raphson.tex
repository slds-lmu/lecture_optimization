...
\begin{framei}{Newton-Raphson vs. GD on Branin function}
\item \textcolor{red}{Red}: Newton-Raphson
\item \textcolor{green}{Green}: Gradient descent
\item Newton-Raphson has much better convergence speed here
\vfill
\splitV[0.475]{
\imageC[1]{figure_man/NR_1.png}
}{
\imageC[1]{figure_man/NR_2.png}
}
\end{framei}
...
\imageC[0.4]{figure_man/NR_2.png}
