...
\comment{BB}{vielleicht noch eine "demotivierende" slide warum 2nd order schlöecht ist in hohen dim
...
\comment{BB}{den schritt auf der quadrik visuasilieren?}
...
\comment{BB}{ich glaube hier ist gar nicht GD laufen gelassen  worden sondern normalized GD. außerdem: warum sind die algos nicht in einer legende sichtbar}
...
\comment{UU}{Warum? Eine schlecht konditionierte Hesse-Matrix könnte Probleme machen. Aber die Lösung des LGS an sich ist nicht das Problem, da es stabile Lösungsverfahren (LU mit Pivoting oder QR-Zerlegung mit Householder-Transformationen) gibt}
