...
\comment{BB}{/https://www.stat.cmu.edu/~ryantibs/convexopt-F13/lectures/11-QuasiNewton.pdf}
...
\comment{BB}{wie genau? wir brauchen echt mehr zu step size control}
...
\comment{BB}{müssen wir hier nicht mit den indizes etwas aufpassen? also dass x = x^t ist}
$$
\begin{aligned}
...
$$
\comment{BB}{formel siehtr falsch aus? A muss inv werden, rest auch komisch?}
\end{itemizeS}
\vfill
...
\comment{BB}{zu pd: vorsicht behaupten wir das vorher?}
\end{itemizeS}
\end{framei}
