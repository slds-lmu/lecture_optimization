...
p = plot_contour_data(f, grid)
ggsave(filename = "figure_man/quadratic_functions_2D_example_1_2.png", p, width = 3, height = 3)
...
ggsave(filename = "figure_man/quadratic_functions_2D_bad_cond_2.png", p, width = 3, height = 3)
