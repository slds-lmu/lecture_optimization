...
\begin{framev}{Other classes of optimization problems}
...
\begin{framev}{Example 1: Best subset selection}
...
\comment[NOTE]{BB}{bild doch eher zu unklar. warumn hat es grau stufen. BIC kommt vor usw;
vielleichzt sollte man heir auch mehr zu BIC AIC usw sagen? oder eben nicht aber dann sollte es inm bild auch nicht vorkommen;
das hier ist ein gutes buch:
miller subset selection regression}
\comment[NOTE]{BB}{wir sollten kurz sagen was NP hard heisst}
\end{framev}


\begin{framev}{Example 2: Wrapper Feature selection}
...
\begin{framev}{Example 3: Feature sel. (multiobjective)}
...
\begin{framev}{Example 4: Hyperparameter optimization}
Solving
$$
...
\comment[NOTE]{BB}{besser groß-Lambda-tilde verwenden. das ist was in der grafik vorkommt}
\end{framev}
\comment[NOTE]{BB}{vielleicht 1 extra slide wo wir mehr allgemein was zu  BB problemen in egineering sagen? und welche aufzählen? das problem hier mit poil wells ist auch nicht super klar? besser einen robter nehmen der rumläuft? oder car crashes? man kann auch was zu constraints und MOO sagen da}
