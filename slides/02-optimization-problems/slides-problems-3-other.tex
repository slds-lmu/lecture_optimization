...
\comment{BB}{bild doch eher zu unklar. warumn hat es grau stufen. BIC kommt vor usw;
...
\comment{BB}{wir sollten kurz sagen was NP hard heisst}
\end{framev}
...
\comment{BB}{besser groß-Lambda-tilde verwenden. das ist was in der grafik vorkommt}
\end{framev}
\comment{BB}{vielleicht 1 extra slide wo wir mehr allgemein was zu  BB problemen in egineering sagen? und welche aufzählen? das problem hier mit poil wells ist auch nicht super klar? besser einen robter nehmen der rumläuft? oder car crashes? man kann auch was zu constraints und MOO sagen da}
