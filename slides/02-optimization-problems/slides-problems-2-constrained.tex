...
\begin{framev}{Constrained Optimization Problem}
$$
...
\comment[NOTE]{BB}{wäre gut wenn man die zielfunktion hier besser sehen könnte}
...
\begin{framev}{Example 1: Unit circle}
$$
\begin{aligned}
...
\end{aligned}
$$
\imageC[0.5]{figure/unit_circle.png}
...
\begin{framev}{Example 2: Maximum likelihood}
...
\end{footnotesize}
\comment[NOTE]{BB}{mit der notation wieder doof hier? --> f ist objective}
\end{framev}


\begin{framev}{Example 3: Ridge regression}
...
\begin{framev}{Example 4: LASSO Regression}
...
\begin{framev}{Example 5: Support Vector Machines}
...
$$
\splitV{
\image[1]{figure/hinge.png}
}{
\begin{footnotesize}
Unconstrained, convex problem with non-smooth objective
\end{footnotesize}
}
\comment[NOTE]{BB}{wäre veilleicht noch schön als biuld die objective mit beiden componenten dabeneb zu sehen?}
\comment[NOTE]{BB}{hier wäre ein deep dive sinnvoll der beweist dass beides äquivalent}
\end{framev}
...
\comment[NOTE]{BB}{sehr blöd dass in den bildern bhier beta und nicht theta steht}
\end{framev}
...
\begin{framev}[fs=footnotesize]{Example 5: Support Vector Machines}
