...
\comment{BB}{wäre gut wenn man die zielfunktion hier besser sehen könnte}
...
\end{footnotesize}
\comment{BB}{mit der notation wieder doof hier? --> f ist objective}
\end{framev}
...
\comment{BB}{wäre veilleicht noch schön als biuld die objective mit beiden componenten dabeneb zu sehen?}
\comment{BB}{hier wäre ein deep dive sinnvoll der beweist dass beides äquivalent}
\end{framev}
...
\comment{BB}{sehr blöd dass in den bildern bhier beta und nicht theta steht}
\end{framev}
