...
\begin{vbframe}{Example 3: Regularized linear model}
...
The problem is still \textbf{multivariate}, \textbf{unconstrained}, but \textcolor{violet}{\textbf{not smooth}}. % The L1 penality is not differentiable if $\exists i$ s.t. $\theta_i = 0$.  
...
\begin{vbframe}{Example 4: Linear model with Hinge loss}
