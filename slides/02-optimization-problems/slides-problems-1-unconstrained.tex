...
Problem \textbf{multivariate}, \textbf{unconstrained}, \textbf{smooth}, \textbf{convex} and has analytical solution. 
...
Regularization reduces the risk of overfitting. Elastic net regularization is a combination of L1 and L2 regularization: 
...
\begin{itemize}
	\item Multivariate
	\item Unconstrained
	\item Smooth if $L$ is smooth and $\alpha = 0$; not smooth otherwise
	\item Convex if $L$ convex
\end{itemize}
