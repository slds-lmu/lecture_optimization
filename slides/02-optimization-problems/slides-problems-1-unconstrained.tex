...
\splitV[0.48]
{
\imageC[0.9]{figure_man/ml_poisson_example_2.pdf}
}
{
\imageC[0.9]{figure_man/ml_poisson_example_3.pdf}
}
...
\vfill
\imageC[0.55]{figure_man/ml_normal_example_dnorm.pdf}
\end{framei}
...
\vfill
\imageC[0.55]{figure_man/ml_normal_example_negloglike_nooptim.pdf}
\end{framei}
...
\vfill
\imageC[0.55]{figure_man/ml_normal_example_negloglike.pdf}
\end{framei}
...
\splitV
{
\imageC[0.95]{figure_man/ml_linreg_example_1.pdf}
}
{
\imageC[0.95]{figure_man/ml_linreg_example_2.pdf}
}
...
\vfill
\imageC[0.8]{figure_man/linreg.pdf}
\end{framei}
...
\vfill
\imageC[0.55]{figure_man/logreg-0.pdf}
\end{framei}
...
\splitVThree
{
\imageC[0.85]{figure_man/logreg-0-0.1.pdf}\par
\imageC[0.85]{figure_man/logreg-0-1.pdf}
}
{
\imageC[0.85]{figure_man/logreg-0.5-0.1.pdf}\par
\imageC[0.85]{figure_man/logreg-0.5-1.pdf}
}
{
\imageC[0.85]{figure_man/logreg-1-0.1.pdf}\par
\imageC[0.85]{figure_man/logreg-1-1.pdf}
}
...
\splitVThree
{
\imageC[0.95]{figure_man/svm_geometry.png}
}
{
\imageC[0.95]{figure_man/hinge.pdf} % See hinge_vs_l2.R
}
{
...
{
\imageC[0.9]{figure_man/hinge.pdf} % See hinge_vs_l2.R
}
\end{framei}
...
\splitVThree
{
\imageC[0.8]{figure_man/ml_landscape.jpg}
}
{
\imageC[0.8]{figure_man/newrep_n_f.png}
}
{
\imageC[0.8]{figure_man/log_reg.png} % Last one taken from Intro to DL, 1.04
}
