...
\comment[NOTE]{BB}{vermutlich sollten wir mal erklären wie sich die richtungs strärkster krümmung zum grad verhält....? in den erklärungen verwecjhseln wir das fast manchmal?}
\end{framei}
...
\end{itemizeM}
\vfill
\splitV{\imageC[0.9]{figure_man/ill-cond_1.png}
}{\imageC[0.9]{figure_man/ill-cond_2.png}}
\end{framei}
