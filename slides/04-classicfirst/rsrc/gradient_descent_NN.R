# Used in: 01-gd.tex,
#   ../06-advfirst/01-momentum.tex,
#   ../06-advfirst/04-sgd.tex (snippet currently not used)
#
...
# --- SGD batch fraction comparison (../06-advfirst/04-sgd.tex) --
if (run_sgd) {
  set_nn_seed(1111L)
  epochs = 100L
  learning_rate = 0.001
