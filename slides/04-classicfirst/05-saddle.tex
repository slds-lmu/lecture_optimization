...
\comment[NOTE]{BB}{hier hätte ich gerne eine folie: in DL sind sattlepoints das problem nicht lok min. diese folie gibt es schon in DL
ist in DL 4.1, folie 21ff}
\comment[NOTE]{BB}{versuchen "slow crawling" zu zeigen. also vielleicht noch ein bsp wo wir im saddle point nicht steckenbleiben aber an ihm super langsam vorbeilaufen
https://arxiv.org/pdf/1711.05224.pdf}
\comment[NOTE]{BB}{https://bair.berkeley.edu/blog/2017/08/31/saddle-efficiency/ --> ansehen.}
\comment[NOTE]{BB}{benutzen wir hier in den slides manchmal "m" als dim des opt problems? gegen cheat sheet checken}
...
\begin{frame}[c]{}
  \centering\LARGE\textbf{Multimodality}
\end{frame}

\begin{framei}{Unimodal vs. Multimodal loss surfaces}
\item[]
\splitV[0.52]
{\splitV[0.54]{\imageC[1]{figure_man/ackley_0a.png}}{\imageC[1]{figure_man/ackley_0b.png}}
\imageC[1][https://arxiv.org/abs/1712.09913]{figure_man/difficult_vs_easy.png}}
...
\item \textbf{In practice:} Only local minima with high value compared to global minimum are problematic.
...
\vfill
\splitV[0.48]{\image{figure_man/ackley_1.png}}{\image{figure/ackley.png}}
\vfill
...
\begin{frame}[c]{}
  \centering\LARGE\textbf{Saddle Points}
\end{frame}

\begin{framev}{GD at saddle points}
\splitV[0.52]
{\textbf{Example:}\\
\spacer
...
\only<5>{\imageC{figure/saddle_point_grad_norm.pdf}}
\begin{center}
