...
\spacer
\imageC[0.8]{figure/expedia-1-1.pdf}
\end{framev}
...
\end{itemize}
\imageC[0.9]{figure/expedia-2-1.pdf}
\spacer
...
\comment[NOTE]{LS}{step function as front as the empirical approximation would be better}
\end{itemize}
\spacer
\splitV[0.5]{
\imageC[1]{figure/expedia-4-1.pdf}
}{
\imageC[1]{figure/expedia-5-1.pdf}
}
\end{framev}
...
$$
\spacer
\imageC[0.6]{figure/expedia-9-1.pdf}
\end{framev}
...
\imageC[1]{figure/expedia-10-1.pdf}
\end{framev}
...
\imageC[0.8]{figure/expedia-11-1.pdf}
\comment[NOTE]{LS}{again step function}
\end{framev}
