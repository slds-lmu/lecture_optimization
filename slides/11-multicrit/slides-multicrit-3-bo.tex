...
\titlemeta{%
  ...
  figure_man/example_parego_spam.png % Relative path to some title page image (optional)
}{%
...
% -------------------------------------------------------------------
\begin{vbframe}{Scalarization: ParEGO~\litw{\href{https://www.cs.bham.ac.uk/~jdk/parego/ParEGO-TR3.pdf}{Knowles. 2006}}}
...
\textbf{SMS-EGO}~\lit{\href{https://doi.org/10.1007/978-3-540-87700-4_78}{Ponweiser et al. 2008}}.
...
\lit{\href{https://doi.org/10.1016/j.swevo.2018.10.007}{Yang et al. 2019}}:
