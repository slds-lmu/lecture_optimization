...
# FIG: 
#  (1) the distribution of income class across different racial groups, separated by sex.
#  (2) examines how different occupations relate to income class, again separated by sex.
