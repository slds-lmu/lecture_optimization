...
# DATA: generate exemplary plots of the objectives plotted against 
#     each other as well as against the decision varianble x
# ------------------------------------------------------------------------------
...
ggsave("../figure_man/graph1.png", p, height = 2, width = 2)
...
ggsave("../figure_man/graph2.png", p, height = 2, width = 2)
...
ggsave("../figure_man/graph3.png", p2, height = 2, width = 2)
