...
\vspace{-0.3cm}
\begin{figure}
\includegraphics[width=0.52\textwidth]{figure_man/example_parego_spam_outer.png}\\
\includegraphics[width=0.52\textwidth]{figure_man/example_parego_spam_outer_pareto.png}
\end{figure}
\end{column}
\end{columns}
