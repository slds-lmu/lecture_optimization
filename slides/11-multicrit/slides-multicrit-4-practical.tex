...
\sourceref{https://archive.ics.uci.edu/ml/datasets/spambase}
\splitV[0.5]{
\begin{itemizeM}
...
\imageC[1]{figure_man/example_parego_spam.png}
}
\end{framev}
...
\imageC[0.6]{figure_man/example_parego_spam_outer.png}
\imageC[0.6]{figure_man/example_parego_spam_outer_pareto.png}
}
\end{framev}
...
\imageC[1]{figure_man/mosmafs_sonar_eval_domHV.pdf}
}
\end{framev}
...
\imageC[0.55]{figure_man/dataset_adult_race.png}
\imageC[0.75]{figure_man/dataset_adult_education.png}
}
\end{framev}
