...
\begin{center}
\includegraphics[width=0.5\linewidth]{figure_man/expedia-3-1.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.75\textwidth]{figure_man/expedia-9-1.pdf}
\end{center}
...
\bigskip
\begin{center}
\includegraphics[scale=1]{figure_man/expedia-11-1.pdf}
\end{center}
...
\begin{column}{0.5\textwidth}
\begin{center}
\includegraphics[width=0.8\textwidth]{figure_man/dominated_hypervolume.png}
\end{center}
\end{column}
\end{columns}
