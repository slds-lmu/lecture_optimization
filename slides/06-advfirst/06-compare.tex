...
\imageC[0.7]{figure/simu-linmods/GD_reg_med_lr_iters.pdf}
\imageC[0.75]{figure/simu-linmods/GD_reg_coef_med.pdf}
...
\imageC[0.7]{figure/simu-linmods/GD_reg_med_lr_corr_iters.pdf}
\imageC[0.75]{figure/simu-linmods/GD_reg_coef_med_corr.pdf}
\item Irreducible error due to additive noise is $\sigma=1$. Dotted lines indicate global minimizers
...
\imageC[0.7]{figure/simu-linmods/GD_reg_small_lr_iters.pdf}
\imageC[0.75]{figure/simu-linmods/GD_reg_coef_small.pdf}
\item Irreducible error due to additive noise is $\sigma=1$. Dotted lines indicate global minimizers
...
\imageC[0.7]{figure/simu-linmods/GD_reg_large_lr_iters.pdf}
\imageC[0.75]{figure/simu-linmods/GD_reg_coef_large.pdf}
\item Irreducible error due to additive noise is $\sigma=1$. Dotted lines indicate global minimizers
...
\imageC[0.7]{figure/simu-linmods/SGD_reg_med_lr_iters.pdf}
\imageC[0.75]{figure/simu-linmods/SGD_reg_coef_med.pdf}
...
\imageC[0.7]{figure/simu-linmods/SGD_reg_large_lr_iters.pdf}
\imageC[0.75]{figure/simu-linmods/SGD_reg_coef_large.pdf}
...
\imageC[0.7]{figure/simu-linmods/GD_log_med_lr_iters.pdf}
\imageC[0.75]{figure/simu-linmods/GD_log_coef_med.pdf}
...
\imageC[0.7]{figure/simu-linmods/GD_log_med_lr_corr_iters.pdf}
\imageC[0.75]{figure/simu-linmods/GD_log_coef_med_corr.pdf}
\item Dotted lines indicate global minimizers
...
\imageC[0.7]{figure/simu-linmods/SGD_log_med_lr_iters.pdf}
\imageC[0.75]{figure/simu-linmods/SGD_log_coef_med.pdf}
...
\imageC[0.7]{figure/simu-linmods/SGD_log_large_lr_iters.pdf}
\imageC[0.75]{figure/simu-linmods/SGD_log_coef_large.pdf}
...
\imageC[0.8]{figure/simu-mnist/SGD_compar.pdf}
...
\imageC[0.9]{figure/simu-mnist/SGD_GD_compar.pdf}
