...
%akwardly i had to put \" We are given a multi-objective optimization problem where we want to minimize both objec-here to make it compile correctly
...
We assume that the fitness shall be maximized, and want to do a simplified CMA-ES update step:
\begin{itemize}
