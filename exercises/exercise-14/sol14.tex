...
\item
  \begin{itemize}
    \item $\mathbf{f}^{(1)} = (10, 5)$ e.g., dominated by $\mathbf{f}^{(4)} = (6, 4)$.
    \item $\mathbf{f}^{(2)} = (7, 8)$ e.g., dominated by $\mathbf{f}^{(3)} = (4, 6)$.
    \item $\mathbf{f}^{(3)}$ not dominated.
    \item $\mathbf{f}^{(4)}$ not dominated.
    \item $\mathbf{f}^{(5)}$ not dominated.
    \item $\mathbf{f}^{(6)}$ not dominated.
  \end{itemize}
  $\rightarrow$ the set of Pareto optimal solutions is $\mathcal{P} = \{\mathbf{f}^{(3)}, \mathbf{f}^{(4)}, \mathbf{f}^{(5)}, \mathbf{f}^{(6)}\}$.
\item
\begin{knitrout}
