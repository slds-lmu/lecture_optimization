...
\begin{enumerate}
	...
	\item $\nabla f =  2\mathbf{w}^\top \Sigma_{\mathbf{X}} - 2\Sigma_{\mathbf{XY}}^\top, \nabla^2f = 2\Sigma_{\mathbf{X}}$
...
\end{knitrout}
\item $\nabla f = (\sin(x_1^2 + x_2^2 + x_1x_2)(2x_1 + x_2), \sin(x_1^2 + x_2^2 + x_1x_2)(2x_2 + x_1))$
