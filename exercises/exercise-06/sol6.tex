...
\hlkwa{for}\hlstd{(i} \hlkwa{in} \hlnum{1}\hlopt{:}\hlnum{500}\hlstd{)\{}
  \hlstd{theta} \hlkwb{=} \hlkwd{gd_step}\hlstd{(theta, alpha, lambda)}
  \hlstd{thetas} \hlkwb{=} \hlkwd{rbind}\hlstd{(thetas, theta)}
\hlstd{\}}

\hlkwd{ggplot}\hlstd{(}\hlkwd{as.data.frame}\hlstd{(thetas),} \hlkwd{aes}\hlstd{(}\hlkwc{x}\hlstd{=V1,} \hlkwc{y}\hlstd{=V2))} \hlopt{+}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlcom{## Lambda = 0.5, alpha = 0.5}
\hlstd{theta} \hlkwb{=} \hlkwd{c}\hlstd{(}\hlnum{0}\hlstd{,}\hlnum{0}\hlstd{)}
\hlstd{alpha} \hlkwb{=} \hlnum{0.01}

\hlstd{thetas} \hlkwb{=} \hlkwa{NULL}
\hlkwa{for}\hlstd{(i} \hlkwa{in} \hlnum{1}\hlopt{:}\hlnum{500}\hlstd{)\{}
  \hlstd{theta} \hlkwb{=} \hlkwd{gd_step}\hlstd{(theta, alpha,} \hlnum{0.5}\hlstd{)}
  \hlstd{thetas} \hlkwb{=} \hlkwd{rbind}\hlstd{(thetas, theta)}
\hlstd{\}}
...
\hlstd{thetas} \hlkwb{=} \hlkwa{NULL}
\hlkwa{for}\hlstd{(i} \hlkwa{in} \hlnum{1}\hlopt{:}\hlnum{500}\hlstd{)\{}
  \hlstd{theta} \hlkwb{=} \hlkwd{gd_backtracking_step}\hlstd{(theta, alpha,} \hlnum{0.9}\hlstd{,} \hlnum{0.5}\hlstd{,} \hlnum{0.5}\hlstd{)}
  \hlstd{thetas} \hlkwb{=} \hlkwd{rbind}\hlstd{(thetas, theta)}
\hlstd{\}}
