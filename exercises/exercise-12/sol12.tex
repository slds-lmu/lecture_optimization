...
\begin{enumerate}
  ...
  \item Along the diagonal $x_{1} = x_{2} = t$, the function simplifies to $$g(t, t) = |t - t| + 0.1 (t + t) = 0.2 t.$$
    ...
    No finite $(x_{1}, x_{2})$ can achieve that inifimum, i.e., there is no global mnimizer, but the values of $g$ can be made arbitrarly negative by letting $x_{1}$, $x_{2}$ be arbitrarly negative.
